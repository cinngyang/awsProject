[ubuntu 環境安裝設定](ubuntu.md)<br>[MySql環境安裝設定](mysql.md)<br>[Python Sample code](https://github.com/cinngyang/ETLTemplate)<br>[flask 建置](flask.md)<br>[Flask Web 結構](WebComponent.md)
